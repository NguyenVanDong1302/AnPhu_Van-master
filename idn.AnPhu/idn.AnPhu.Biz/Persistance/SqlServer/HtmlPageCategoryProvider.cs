...
namespace idn.AnPhu.Biz.Persistance.SqlServer
{
    public class HtmlPageCategoryProvider : DataAccessBase, IHtmlPageCategoryProvider
    {
        ...
        public void Add(HtmlPageCategory item, string Culture)
        {
            ...
            comm.AddParameter<string>(this.Factory, "HtmlPageCategorySummary", item.HtmlPageCategorySummary);
            ...
            comm.AddParameter<string>(this.Factory, "HtmlPageCategoryImage", item.HtmlPageCategoryImage);
            comm.AddParameter<string>(this.Factory, "HtmlPageCategoryImage2", item.HtmlPageCategoryImage2);
        ...
        {
            var listPageBase = new List<HtmlPageCategoryBase>();
            if (s != null)
            {
                listPageBase.AddRange(s.Cast<HtmlPageCategoryBase>());
            }
